...
async def orders() -> dict:
    ...
    """
    return await async_make_request(method='get', endpoint='/api/iserver/account/orders')


async def place_order(account_id: str, order: dict) -> dict:
    """Places an order.
    ...
    """
    return await async_make_request(method='post', endpoint=f'/api/iserver/account/{account_id}/order',
                                    json_payload=order)
...
async def modify_order(account_id: str, order_id: str, order: dict) -> dict:
    ...
    """
    return await async_make_request(method='post', endpoint=f'/api/iserver/account/{account_id}/order/{order_id}',
                                    json_payload=order)


async def delete_order(account_id: str, order_id: str) -> Union[list, dict]:
    """Deletes an order.
    ...
    """
    return await async_make_request(method='delete', endpoint=f'/api/iserver/account/{account_id}/order/{order_id}')


async def place_whatif_order(account_id: str, order: dict) -> dict:
    ...
    """
    return await async_make_request(method='post', endpoint=f'/api/iserver/account/{account_id}/order/whatif',
                                    json_payload=order)


async def reply(reply_id: str, message: dict) -> Union[list, dict]:
    ...
    """
    return await async_make_request(method='post', endpoint=f'/api/iserver/reply/{reply_id}', json_payload=message)
